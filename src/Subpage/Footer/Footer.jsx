    ...
    <>
      ...
      >
        <div>
          ...
          />
          <img
            src="https://i.ibb.co/rGYH5F3/Abstract-Breaking-Live-News-Free-Logo-1.png"
            alt=""
            className={"-mt-40"}
          />
          <h3 className={"-mt-24"}>Your Ultimate Streaming Platform</h3>
          <p className={"mb-6 mt-4"}>Copyright © 2023 - All right reserved</p>
